"""
Django settings for the botstore project.
...
WSGI_APPLICATION = "botstore.wsgi.application"
...
CKEDITOR_UPLOAD_PATH = "uploads/"  # Configure upload path if needed
...
CKEDITOR_5_CUSTOM_CSS = "static/css/custom_ckeditor.css"  # Optional custom CSS

# Custom storage class (Optional, define if needed)
# from blog.storage import CustomStorage
